...
As of right now, this program reads in a text file that specifies the current board. The board is specified by 'row col number' (where 1,1 is the left bottom corner). An example text file with a board of size 8x8 would look like:
